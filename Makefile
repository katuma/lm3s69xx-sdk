...
CFLAGS=-mthumb -mcpu=cortex-m3 -mfix-cortex-m3-ldrd -T lm3s6965.ld -I. -Ilwip/src/include -Ilwip/src/include/ipv4  -Ilwip/src/include/ipv6 -std=c99 -Dsourcerygxx=1 -ggdb
